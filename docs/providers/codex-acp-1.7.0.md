...
capture the ACP initialize + session/new surface through codex-acp
...
- `G1`: session-discovery-codex-acp
...
- `.result.agentCapabilities.mcpCapabilities.acp` `G1`
...
- `.result.agentCapabilities.sessionCapabilities.subagents` `G1`
- `.result.agentInfo` `G1`
- `.result.agentInfo.name` `G1`
- `.result.agentInfo.title` `G1`
- `.result.agentInfo.version` `G1`
- `.result.authMethods` `G1`
- `.result.authMethods[]._meta` `G1`
- `.result.authMethods[]._meta.api-key` `G1`
- `.result.authMethods[]._meta.api-key.provider` `G1`
...
- `.result.configOptions[].options[]._meta` `G1`
- `.result.configOptions[].options[]._meta.kind` `G1`
...
- `.result.modes.availableModes[]._meta` `G1`
- `.result.modes.availableModes[]._meta.kind` `G1`
