...
#[cfg(test)]
use approval::APPROVAL_MARKER_CONTENT;
#[cfg(windows)]
use approval::file_identity;
use approval::{
    APPROVAL_MARKER_ADD_DIFF, APPROVAL_MARKER_NAME, CODEX_APPROVAL_COMMAND, ClaudeApprovalState,
    DirectoryIdentity, FileIdentity, observe_claude_approval_frame, repository_root,
    require_empty_approval_target, resolve_trusted_powershell, validate_on_request_preflight,
...
use approval::{canonical_protected_roots, select_trusted_powershell, windows_protected_roots};
...
mod tests {
    ...
    use super::test_support::{
        absolute_program, channel_payloads, config, contains_response_id, contract_request,
        find_named_file, fixture_path, isolated_approval_target, isolated_tempdir,
    };
    use super::{
        APPROVAL_MARKER_NAME, CaptureOperation, Channel, ClaudeCaptureOperation, ClaudeRunScript,
        CodexCaptureOperation, CodexRunScript, CommandSnapshot, LaunchDescriptor, Provider,
        RecordingSession, StdioMode, failed_session_stdin, persist_immutable_bytes, record,
        sanitize_dir,
    };
